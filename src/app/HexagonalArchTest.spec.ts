...
describe('HexagonalArchTest', () => {
  const srcProject = new TypeScriptProject(RelativePath.of('src/app'));
  ...
  describe('BoundedContexts', () => {
    [...sharedKernels, ...businessContexts].forEach((context: string) => {
      it(`Should ${context} not depend on other bounded context domains`, () => {
        noClasses()
          .that()
  ...
  describe('Domain', () => {
    ...
    [...sharedKernels, ...businessContexts].forEach((context: string) => {
      it(`should be an hexagonal architecture in context ${context}`, () => {
  ...
  describe('Secondary', () => {
    ...
    [...sharedKernels, ...businessContexts].forEach((context: string) => {
      it(`should ${context} not depend on same context primary`, () => {
        noClasses()
          .that()
